...
:root {
    ...
    /* General Colors */
    --border-color: #da4a60;
    --drag-gradient1: #75195e;
    --drag-gradient2: #790d48;
    --name-bg: #640f1f;
    ...
    --bg-gradient2: #79154f;
    --bg-gradient3: #54b5de;
    --bg-image: url('https://cdn.phaze.gay/cdn/97589071_p0_master1200.jpg'); /* Write the image url, example url("your url") [none is default]*/
    --opacity: 0; /* Value in numbers from 0 to 1, but there is a limit */
    --bg-blur: 2px; /* Value in px */
    ...
    --idle-color: #ffca3a;
    --dnd-color: #f73c3c;
    --offline-color: #707070;
    --streaming-color: #f066f0;

    /* Chatbar Colors */
    --channeltextarea-background: #118d8d;
    --text-color: #313D40;
    --icon-color: var(--text-color);
    --selected-text-bg: var(--text-color);
    --selected-text-color: var(--channeltextarea-background);
